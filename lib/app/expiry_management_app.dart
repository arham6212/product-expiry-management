...
import '../features/product_resolution/application/product_image_controller.dart';
    ...
    return ProviderScope(
      overrides: [
        ...
        productImageContributionRepositoryProvider.overrideWithValue(
          dependencies.productImageContributionRepository,
        ),
        if (dependencies.productImagePicker != null)
          productImagePickerProvider.overrideWithValue(dependencies.productImagePicker!),
        if (dependencies.productImageProcessor != null)
          productImageProcessorProvider.overrideWithValue(dependencies.productImageProcessor!),
